...
from cotbridge.bridge import run_all
...
LOG = logging.getLogger("cotbridge")
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        help=f"INI config path (default: {default_config_path()}, or env COTBRIDGE_CONFIG)",
    )
    ...
    try:
        ...
        logging.getLogger("cotbridge").error("%s", exc)
